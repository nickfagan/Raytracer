...
int gr_light_cmd(lua_State* L)
{
  ...
  l.intensity = luaL_checknumber(L, 4);
...
// Make a box light
extern "C"
int gr_box_light_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;
  ...
  l.intensity = luaL_checknumber(L, 4);
  l.size = luaL_checknumber(L, 5);

  l.colour = Colour(col[0], col[1], col[2]);
  
  data->light = new BoxLight(l);
...
extern "C"
int gr_ref_material_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;
  ...
  data->material = new RefMaterial(Colour(kd[0], kd[1], kd[2]), Colour(ks[0], ks[1], ks[2]), shininess, reflection);

  luaL_newmetatable(L, "gr.ref_material");
  lua_setmetatable(L, -2);
...
// Set a node's reflective material material
extern "C"
int gr_node_set_ref_material_cmd(lua_State* L)
{
  GRLUA_DEBUG_CALL;
  ...
  gr_material_ud* matdata = (gr_material_ud*)luaL_checkudata(L, 2, "gr.ref_material");
...
static const luaL_reg grlib_functions[] = {
  ...
  {"ref_material", gr_ref_material_cmd},
  {"cube", gr_cube_cmd},
  {"nh_sphere", gr_nh_sphere_cmd},
  {"nh_box", gr_nh_box_cmd},
  {"mesh", gr_mesh_cmd},
  {"light", gr_light_cmd},
  {"box_light", gr_box_light_cmd},
...
static const luaL_reg grlib_node_methods[] = {
  ...
  {"set_ref_material", gr_node_set_ref_material_cmd},
